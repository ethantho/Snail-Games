...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        private readonly Collider2D[] _groundHits = new Collider2D[2];
        ...
        protected virtual void CheckCollisions() {
            ...
            // Ground and Ceiling
            //_groundHitCount = Physics2D.CapsuleCastNonAlloc(_col.bounds.center, _col.size, _col.direction, 0, -transform.up, _groundHits, _stats.GrounderDistance, ~_stats.PlayerLayer);
